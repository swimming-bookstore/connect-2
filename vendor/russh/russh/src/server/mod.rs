...
pub struct Config {
    ...
    /// Optional OpenSSH host certificate blob (Teleport host cert). When set,
    /// advertised as `host_cert_algo` and sent in KEX instead of the raw pubkey.
    pub host_cert: Option<Vec<u8>>,
    pub host_cert_algo: Option<Algorithm>,
